...
package com.example.com.ecommapp.onekeyshare.themes.classic.land;
...
import com.example.com.ecommapp.onekeyshare.OnekeyShareThemeImpl;
import com.example.com.ecommapp.onekeyshare.themes.classic.EditPage;
import com.example.com.ecommapp.onekeyshare.themes.classic.XView;
...
public class EditPageLand extends EditPage implements OnClickListener, TextWatcher, Runnable {
	...
	public void onCreate() {
		...
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, titleHeight);
		...
		lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
		...
		rlBody.addView(llShadow, new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT));
	...
	private void initBody(RelativeLayout rlBody, float ratio) {
		...
		rlBody.addView(svContent, new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT));

		LinearLayout llContent = new LinearLayout(activity);
		llContent.setOrientation(LinearLayout.HORIZONTAL);
		svContent.addView(llContent, new ScrollView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
	...
	private void initBottom(LinearLayout llBottom, float ratio) {
		...
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, bottomHeight);
		...
		lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, px1);
		llBottom.addView(v, lp);
	}

	private void initShadow(LinearLayout llShadow, float ratio) {
		int px1 = ratio > 1 ? ((int) ratio) : 1;
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, px1);
